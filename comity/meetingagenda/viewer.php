...
if ((!comity_isMember($comity_id)) AND (!comity_isadmin($comity_id))) {
    redirect($CFG->wwwroot.'/course/view.php?id='.comity_check($comity_id), 'You are not a member of this committee and therefore do not have permission to view this page.', 2);
}
