...
//---------Agenda Topics--------------------------------------------------------
//------------------------------------------------------------------------------
$mform->addElement('header', 'mod-committee-create_topics', get_string('create_topics', 'comity'));
...
$repeatarray=array();
    ...
    $submit = &$mform->createElement('submit', 'remove_topic', get_string('remove_topic','comity'));
    $submit->setLabel('&nbsp;');
    $repeatarray[]=$submit;
...
$mform->addElement('checkbox','notify_now', get_string('sendnotificationnow', 'comity'));
$mform->addHelpButton('notify_now','sendnotificationnow','comity');
$mform->addElement('html', '<br>');
