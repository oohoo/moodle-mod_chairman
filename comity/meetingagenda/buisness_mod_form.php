...
$mform->addElement('header', 'mod-committee-participants_header', get_string('participants_header', 'comity'));
...
$submit = &$mform->addElement('submit', 'new_moodle_member', get_string('add_moodle_user','comity'));
$submit->setLabel('&nbsp;');
...
//------------------------------------------------------------------------------
  ...
  $sql = "SELECT DISTINCT cag.id, cag.firstname,cag.lastname FROM {comity_agenda_guests} cag,{comity_events} ce,{comity_agenda} ca WHERE cag.moodleid IS NULL " .
...
$submit = &$mform->addElement('submit', 'add_new_guest',get_string('add_new_guest', 'comity'));
$submit->setLabel('&nbsp;');
...
$mform->addElement('header', 'mod-committee-topic_header', get_string('topics_header', 'comity'). " " . $index);
...
$votes = array();
    $votes[] =$mform->createElement('static', "", "", get_string('topic_vote_aye', 'comity'));
    $votes[] =$mform->createElement('text', "aye_new[$index]", '', array('size'=>'3','maxlength'=>"3"));
    $votes[] =$mform->createElement('static', "", "", get_string('topic_vote_nay', 'comity'));
    $votes[] =$mform->createElement('text', "nay_new[$index]", '', array('size'=>'3','maxlength'=>"3"));
    $votes[] =$mform->createElement('static', "", "", get_string('topic_vote_abs', 'comity'));
...
$submit = &$mform->addElement('submit', "add_motion[$index]", get_string('add_update_motions','comity'));
$submit->setLabel('&nbsp;');
