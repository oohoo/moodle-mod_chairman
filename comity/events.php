...
foreach($events as $event) {
    ...
    $event_start_str = comity_convert_strdate_time($event->year, $event->day, $event->month, $event->starthour, $event->startminutes);
    $event_end_str = comity_convert_strdate_time($event->year, $event->day, $event->month, $event->endhour, $event->endminutes);
    ...
    $offset = comity_get_timezone_offset($event->timezone,$region_tz);
    ...
    */
    ...
    echo '<br/>';
    echo '<a href="'.$CFG->wwwroot.'/mod/comity/add_event_moodle_cal.php?event_id='.$event->id.'">'.get_string('addtomoodlecalendar','comity').'</a></br>';
