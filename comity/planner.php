...
foreach($planners as $planner){
    ...
    if(comity_isadmin($id)){
        ...
        echo '&nbsp;&nbsp;&nbsp;<a href="'.$CFG->wwwroot.'/mod/comity/planner_delete.php?id='.$planner->id.'&comityid='.$id.'" onClick="return confirm(\''.get_string('deleteplannerquestion', 'comity').'\');"><img src="'.$CFG->wwwroot.'/mod/comity/pix/delete.gif"></a>';
    }
 echo '</div>';
    print '<table width="100%"><tr><td>';
    echo get_string('timezone_acutally_used','mod_comity')." $planner->timezone<br>";
    if ($USER->timezone == '99'){
        if ($CFG->timezone == '99'){
    ...
    echo get_string('user_timezone','mod_comity')."<br><br>";
