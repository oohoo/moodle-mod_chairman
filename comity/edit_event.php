...
if(comity_isadmin($id)) {
    ...
    echo '<tr>';
    echo '<td valign="top">'.get_string('timezone_used','mod_comity').'</td>';
    //Timezone
...
//------------------------------------------------------------------------------
    ...
    //Notifications
    echo '<tr><td valign="top" colspan="2">'.get_string('sendnotification', 'comity').' : ';
    ...
    echo '&nbsp;&nbsp;'.get_string('sendnotificationweek', 'comity').'<input type="checkbox" name="notify_week" value="1" '.$checked_week.'>';
    echo '</textarea></td></tr>';
    //Buttons
