...
print $CFG->wwwroot . '/mod/chairman/meetingagenda/view.php"){';
print<<<HERE
...
$url = "$CFG->wwwroot/mod/chairman/meetingagenda/pdf_script.php?event_id=" . $event_id;
$url .= '&plain_pdf=1';
...
//for each topic_id that is returned in array
        ...
        redirect($CFG->wwwroot . '/mod/chairman/meetingagenda/view.php?event_id=' . $event_id . '&selected_tab=' . $selected_tab);
...
//--------COMPLETE AGENDA BUTTON PRESSED----------------------------------------
        ...
        redirect($CFG->wwwroot . '/mod/chairman/events.php?id=' . $chairman_id);
...
//---------------------------------------------------------------------------
        ...
        $url = "<a href=$CFG->wwwroot/mod/chairman/edit_event.php?id=$chairman_id&event_id=$event_id>Change/Edit</a>";
...
//echo $scheduler_form;
//$scheduler_form->initalize_popup($agenda_id, $COURSE->id, "$event_record->year,$event_record->month,$event_record->day,$event_record->starthour,$event_record->startminutes", "$event_record->year,$event_record->month,$event_record->day,$event_record->endhour,$event_record->endminutes", $chairman->name);
...
HERE;
            ...
            redirect("$CFG->wwwroot/mod/chairman/meetingagenda/view.php?event_id=".$event_id);
}
?>