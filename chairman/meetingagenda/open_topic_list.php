...
if(isset($is_viewer)){
$return_url = $CFG->wwwroot."/mod/chairman/meetingagenda/viewer.php?chairman_id=".$chairman_id."&selected_tab=".$selected_tab;
} else {
$return_url = $CFG->wwwroot."/mod/chairman/meetingagenda/view.php?event_id=".$event_id."&selected_tab=".$selected_tab;
}
