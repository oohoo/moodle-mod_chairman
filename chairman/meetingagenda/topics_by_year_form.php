...
require_once("$CFG->dirroot/mod/chairman/meetingagenda/agenda_link.css");
...
$url = "$CFG->wwwroot/mod/chairman/meetingagenda/view.php?event_id=" . $topic->eid . "&selected_tab=" . 3;
...
$mform->registerElementType('filemanager_view_only', "$CFG->dirroot/mod/chairman/meetingagenda/filemanager_view_only.php", 'MoodleQuickForm_Modified_Filemanager');
