...
require_once("$CFG->dirroot/mod/chairman/meetingagenda/agenda_viewer.css");
...
$url = "$CFG->wwwroot/mod/chairman/meetingagenda/view.php?event_id=" . $agenda->id . "&selected_tab=" . 1;
