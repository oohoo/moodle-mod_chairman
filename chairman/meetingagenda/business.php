...
require_once("$CFG->dirroot/mod/chairman/meetingagenda/moodle_user_selector.php");
require_once("$CFG->dirroot/mod/chairman/meetingagenda/business.css");
...
//-------------------ADDING NEW MOTION FROM TOPIC-------------------------------
   ...
   redirect("$CFG->wwwroot/mod/chairman/meetingagenda/view.php?event_id=" . $event_id . "&selected_tab=" . $selected_tab . "#topic_" . $topic_return);
}
...
//------------------------------------------------------------------------------
        ...
        //Display Menu
        require_once("$CFG->dirroot/mod/chairman/meetingagenda/buisness_sidebar.php");
