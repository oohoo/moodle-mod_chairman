...
/*print<<<HERE
/*<div class="view_type">
<a href="$CFG->wwwroot/mod/chairman/meetingagenda/viewer.php?chairman_id=$chairman_id&selected_tab=$selected_tab" ALIGN=RIGHT>List View</a>
</div>
HERE;
...
print<<<HERE
<div class="view_type">
<a href="$CFG->wwwroot/mod/chairman/meetingagenda/view.php?event_id=$event_id&selected_tab=$selected_tab" ALIGN=RIGHT>List View</a>
</div>
HERE;*/
}
//------------------------------------------------------------------------------
...
$mform = new mod_agenda_motions_by_year_form($event_id, $agenda_id, $chairman_id, $cm->instance);
...
//Display Menu
require_once("$CFG->dirroot/mod/chairman/meetingagenda/topic_by_year_sidebar.php");
...
/*print<<<HERE
<div class="view_type">
<a href="$CFG->wwwroot/mod/chairman/meetingagenda/viewer.php?chairman_id=$chairman_id&selected_tab=$selected_tab&detailed=1" ALIGN=RIGHT>Detailed View</a>
</div>
HERE;
...
print<<<HERE
<div class="view_type">
<a href="$CFG->wwwroot/mod/chairman/meetingagenda/view.php?event_id=$event_id&selected_tab=$selected_tab&detailed=1" ALIGN=RIGHT>Detailed View</a>
</div>
HERE;*/
    }
//------------------------------------------------------------------------------
...
$mform = new mod_agenda_motions_by_year_list_form($event_id, $agenda_id, $chairman_id, $cm->instance);
