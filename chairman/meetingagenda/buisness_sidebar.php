...
require_once("$CFG->dirroot/mod/chairman/meetingagenda/business_menu_style.css");
...
foreach($agendas as $agenda){
    $url = "$CFG->wwwroot/mod/chairman/meetingagenda/view.php?event_id=" . $agenda->id . "&selected_tab=" . 3;
...
foreach($agendas as $agenda){
$url = "$CFG->wwwroot/mod/chairman/meetingagenda/view.php?event_id=" . $agenda->id . "&selected_tab=" . $selected_tab;
 print '<li><a href="'.$url.'">'.toMonth($agenda->month) ." ".$agenda->day.", ".$agenda->year.'</a></li>';
}
