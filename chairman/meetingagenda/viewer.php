...
$PAGE->set_url('/mod/chairman/meetingagenda/viewer.php?chairman_id='.$chairman_id);
    ...
    $navlinks = array(
     ...
     array('name' => get_string('event','chairman'), 'link' => $CFG->wwwroot.'/mod/chairman/events.php?id='.$chairman_id, 'type' => 'misc')
    );
