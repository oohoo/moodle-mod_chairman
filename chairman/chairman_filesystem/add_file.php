        ...
        if($fileid=='') {
            ...
            if (isset($_FILES['userfile']['name'])) {
                ...
                if (!$DB->insert_record('chairman_files',$insert)) {
                    ...
                    echo 'window.location.href="'.$CFG->wwwroot.'/mod/chairman/chairman_filesystem/files.php?id='.$id.'&file='.$file.'";';
                    echo '</script>';
                }
            }
        }
...
//print_object($breadcrumb);
    ...
    echo '<input type="button" value="'.get_string('cancel', 'chairman').'" onClick="parent.location=\''.$CFG->wwwroot.'/mod/chairman/chairman_filesystem/files.php?id='.$id.'&file='.$file.'\'"></td></tr>';
