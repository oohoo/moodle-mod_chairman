...
if($DB->get_records('chairman_files',array('parent'=>$folder_id))) {
    ...
    echo '<br/><br/>';
    echo '<a href="'.$CFG->wwwroot.'/mod/chairman/files.php?id='.$id.'&file='.$folderobj->parent.'">'.get_string('back','chairman').'</a>';
}
else {
    $success = true;
...
if($success){
    ...
    echo 'window.location.href="'.$CFG->wwwroot.'/mod/chairman/files.php?id='.$id.'&file='.$folderobj->parent.'";';
    echo '</script>';
}
?>
