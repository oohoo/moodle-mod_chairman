...
if(chairman_isadmin($id)) {
    ...
    echo '<form action="'.$CFG->wwwroot.'/mod/chairman/add_folder_script.php?id='.$id.'" method="POST" name="newfolder">';
    ...
    echo '<input type="button" value="'.get_string('cancel', 'chairman').'" onClick="window.location=\''.$CFG->wwwroot.'/mod/chairman/files.php?id='.$id.'&file='.$file.'\'"></td>';
    echo '</tr>';
    echo '</table>';
    echo '</form>';
