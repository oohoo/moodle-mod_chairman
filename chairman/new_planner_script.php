...
if ($notify_now == 1){
	...
	$emailmessage = str_replace('{link}', "$CFG->wwwroot/mod/chairman/planner.php?id=$id", $emailmessage);
...
echo 'window.location.href="'.$CFG->wwwroot.'/mod/chairman/planner.php?id='.$id.'";';
echo '</script>';
