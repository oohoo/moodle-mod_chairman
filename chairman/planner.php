...
if(chairman_isadmin($id)){
    echo '<input type="button" value="'.get_string('newplanner','chairman').'" onclick="window.location.href=\''.$CFG->wwwroot.'/mod/chairman/newplanner.php?id='.$id.'\';" /><br/><br/>';
}
...
foreach($planners as $planner){
    ...
    if(chairman_isadmin($id)){
        echo '&nbsp;&nbsp;&nbsp;<a href="'.$CFG->wwwroot.'/mod/chairman/newplanner.php?id='.$id.'&planner='.$planner->id.'"><img src="'.$CFG->wwwroot.'/pix/t/edit.gif"></a>';
        if($planner->active==1){
            echo '&nbsp;&nbsp;&nbsp;<a href="'.$CFG->wwwroot.'/mod/chairman/planner_active.php?id='.$planner->id.'"><img src="'.$CFG->wwwroot.'/pix/i/hide.gif"></a>';
        }
        else{
            echo '&nbsp;&nbsp;&nbsp;<a href="'.$CFG->wwwroot.'/mod/chairman/planner_active.php?id='.$planner->id.'"><img src="'.$CFG->wwwroot.'/pix/t/show.gif"></a>';
        }
        echo '&nbsp;&nbsp;&nbsp;<a href="'.$CFG->wwwroot.'/mod/chairman/planner_delete.php?id='.$planner->id.'&chairmanid='.$id.'" onClick="return confirm(\''.get_string('deleteplannerquestion', 'chairman').'\');"><img src="'.$CFG->wwwroot.'/mod/chairman/pix/delete.gif"></a>';
    }
 echo '</div>';
    ...
    if($planner->active==0){
        ...
        echo '<input type="button" value="'.get_string('viewresults','chairman').'" onclick="window.location.href=\''.$CFG->wwwroot.'/mod/chairman/viewplanner.php?id='.$planner->id.'\';">';
    }
    else{
        ...
        echo '<input type="button" value="'.get_string('respond','chairman').'" onclick="window.location.href=\''.$CFG->wwwroot.'/mod/chairman/viewplanner.php?id='.$planner->id.'\';">';
    }
    echo '</table><br/><br/>';
}
